...
(module
 ...
 (data (i32.const 752) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 816) "insufficient balance\00")
 ...
 (data (i32.const 1168) "must deposit positive quantity\00")
 ...
 (data (i32.const 1376) "game not found\00")
 (data (i32.const 1392) "game not expired\00")
 (data (i32.const 1424) "unexpected error in fixed_key constructor\00")
 (data (i32.const 1472) "game error\00")
 (data (i32.const 1488) "multiplication overflow or underflow\00")
 (data (i32.const 1536) "multiplication underflow\00")
 (data (i32.const 1568) "multiplication overflow\00")
 (data (i32.const 1600) "offer not found\00")
 (data (i32.const 1616) "unable to reveal\00")
 (data (i32.const 1648) "player already revealed\00")
 (data (i32.const 1680) "offer does not exists\00")
 (data (i32.const 1712) "unable to cancel offer\00")
 (data (i32.const 1744) "only core token allowed\00")
 (data (i32.const 1776) "invalid bet\00")
 (data (i32.const 1792) "must bet positive quantity\00")
 (data (i32.const 1824) "offer with this commitment already exist\00")
 ...
 (func $_ZN5boost4hana13for_each_implINS0_9tuple_tagENS0_4whenILb1EEEE5applyIRNS0_5tupleIJNS7_IJNS0_9type_implIN5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS9_10indexed_byILy4229443000054317056ENS_11multi_index13const_mem_funISC_yXadL_ZNKSC_6by_betEvEEEEEENSD_ILy4982431883047354368ENSF_ISC_NS9_9fixed_keyILj32EEEXadL_ZNKSC_13by_commitmentEvEEEEEEEE5indexILy4229443000054317056ESG_Ly0ELb0EEEE1_ENS8_INSN_ILy4229443000054317056ESG_Ly0ELb1EEEE1_EEEENS7_IJNS8_INSN_ILy4982431883047354368ESK_Ly1ELb0EEEE1_ENS8_INSN_ILy4982431883047354368ESK_Ly1ELb1EEEE1_EEEEEEEZNSM_6modifyIZNSB_8offerbetERKNS9_5assetEyRK11checksum256EUlRT_E5_EEvRKSC_yOS1B_EUlS1C_E_EEvS1G_OT0_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (i32.store offset=4
 ...
 (func $_ZZN5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS_10indexed_byILy4229443000054317056EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_6by_betEvEEEEEENS3_ILy4982431883047354368ENS6_IS2_NS_9fixed_keyILj32EEEXadL_ZNKS2_13by_commitmentEvEEEEEEEE6modifyIZNS1_8offerbetERKNS_5assetEyRK11checksum256EUlRT_E5_EEvRKS2_yOSL_ENKUlSM_E_clINS4_4hana5tupleIJNST_9type_implINSD_5indexILy4982431883047354368ESB_Ly1ELb0EEEE1_ENSV_INSW_ILy4982431883047354368ESB_Ly1ELb1EEEE1_EEEEEEDaSM_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $_ZN5boost4hana13for_each_implINS0_9tuple_tagENS0_4whenILb1EEEE5applyIRNS0_5tupleIJNS7_IJNS0_9type_implIN5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS9_10indexed_byILy4229443000054317056ENS_11multi_index13const_mem_funISC_yXadL_ZNKSC_6by_betEvEEEEEENSD_ILy4982431883047354368ENSF_ISC_NS9_9fixed_keyILj32EEEXadL_ZNKSC_13by_commitmentEvEEEEEEEE5indexILy4229443000054317056ESG_Ly0ELb0EEEE1_ENS8_INSN_ILy4229443000054317056ESG_Ly0ELb1EEEE1_EEEENS7_IJNS8_INSN_ILy4982431883047354368ESK_Ly1ELb0EEEE1_ENS8_INSN_ILy4982431883047354368ESK_Ly1ELb1EEEE1_EEEEEEEZNSM_6modifyIZNSB_8offerbetERKNS9_5assetEyRK11checksum256EUlRT_E4_EEvRKSC_yOS1B_EUlS1C_E_EEvS1G_OT0_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (i32.store offset=4
 ...
 (func $_ZZN5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS_10indexed_byILy4229443000054317056EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_6by_betEvEEEEEENS3_ILy4982431883047354368ENS6_IS2_NS_9fixed_keyILj32EEEXadL_ZNKS2_13by_commitmentEvEEEEEEEE6modifyIZNS1_8offerbetERKNS_5assetEyRK11checksum256EUlRT_E4_EEvRKS2_yOSL_ENKUlSM_E_clINS4_4hana5tupleIJNST_9type_implINSD_5indexILy4982431883047354368ESB_Ly1ELb0EEEE1_ENSV_INSW_ILy4982431883047354368ESB_Ly1ELb1EEEE1_EEEEEEDaSM_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
